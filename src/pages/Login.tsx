...
const Login = () => {
  ...
  const onSubmit = async (data: LoginFormValues) => {
    ...
    try {
      ...
      // Save authentication token and user name to localStorage
      localStorage.setItem("authToken", "example-auth-token");
      
      // Extract user name from email (for demonstration purposes)
      ...
      <div className="hidden md:block w-1/2 bg-indigo-100">
        <div className="h-full flex items-center justify-center p-8">
          <div className="max-w-md">
            <img
              src="https://images.unsplash.com/photo-1631631480669-535cc43f2327?ixlib=rb-4.0.3&auto=format&fit=crop&w=1500&q=80"
              alt="Lost and Found"
